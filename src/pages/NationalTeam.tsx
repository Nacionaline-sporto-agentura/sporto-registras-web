...
import { buttonsTitles, inputLabels, nationalTeamHistoryDescriptions, validationTexts } from '../utils/texts';
          ...
          <Container>
            ...
            {!isNewRequest && (
              <HistoryContainer
                ...
                diff={changes as any}
                data={values}
                requestFormHistoryDescriptions={nationalTeamHistoryDescriptions}
              />
            )}
          </Container>
        );
