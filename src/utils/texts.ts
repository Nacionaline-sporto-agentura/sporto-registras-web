...
export const descriptions = {
  ...
  disabledAccessible: 'Patekimas į sporto bazę pritaikytas žmonėms su judėjimo negalia',
  blindAccessible: 'Patekimas į sporto bazę pritaikytas žmonėms su regėjimo negalia',
