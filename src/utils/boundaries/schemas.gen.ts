...
export const $Address = {
    ...
    type: 'object',
    required: ['code', 'feature_id', 'plot_or_building_number', 'building_block_number', 'postal_code', 'street', 'residential_area', 'municipality', 'geometry'],
    title: 'Address'
} as const;

export const $AddressSearchSortBy = {
    type: 'string',
    enum: ['code', 'plot_or_building_number', 'building_block_number', 'postal_code', 'feature_id', 'created_at'],
...
- **\`contains\`**: filter geometries that are completely within the specified geometry.`,
        ...
        ewkb: {
            ...
            examples: ['0103000020E6100000010000000500000045F6419605473940B1DD3D40F7574B4045F641960547394061E124CD1F574B40719010E50B4A394061E124CD1F574B40719010E50B4A3940B1DD3D40F7574B4045F6419605473940B1DD3D40F7574B40']
        },
        ewkt: {
            anyOf: [
                {
            ...
            examples: ['SRID=4326;POLYGON((25.277429 54.687233, 25.277429 54.680658, 25.289244 54.680658, 25.289244 54.687233, 25.277429 54.687233))']
        },
        geojson: {
            anyOf: [
                {
            ...
            examples: ['{"crs":{"type":"name","properties":{"name":"EPSG:4326"}},"type":"Polygon","coordinates":[[[25.277429,54.687233],[25.277429,54.680658],[25.289244,54.680658],[25.289244,54.687233],[25.277429,54.687233]]]}']
        }
    },
    type: 'object',
...
export const $ShortAddress = {
    ...
    type: 'object',
    required: ['code', 'feature_id', 'plot_or_building_number', 'building_block_number', 'postal_code', 'street', 'residential_area', 'municipality'],
    title: 'ShortAddress'
} as const;
...
export const $Street = {
    ...
    type: 'object',
    required: ['code', 'feature_id', 'name', 'full_name', 'length_m', 'created_at', 'residential_area'],
    title: 'Street'
} as const;
...
export const $StreetWithGeometry = {
    ...
    type: 'object',
    required: ['code', 'feature_id', 'name', 'full_name', 'length_m', 'created_at', 'residential_area', 'geometry'],
